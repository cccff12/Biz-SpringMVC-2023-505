...
public class HomeController {
	...
	public String home(Model model) {
		List<BBsDto> bbsList = bbsService.selecAll();
		model.addAttribute("BBS_LIST", bbsList);
		return "home";
	}

//			@RequestMapping(value = "/insert", method = RequestMethod.GET) GetMapping 과 같음
//			Spring 4.3 이후에 생성된 새로운 Mapping이다
...
//	매개변수를 long형을 받을떄는 @RequestParam을 붙여줘야 400오류가 안남
	...
	public String update(@ModelAttribute("BBS") BBsDto bbsDto,

			@RequestParam("b_file") MultipartFile b_file, MultipartHttpServletRequest b_files) {
