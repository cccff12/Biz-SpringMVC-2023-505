...
//	builder 패턴으로 객체를 생성할때 기본 변수값 설정하기 
	...
	/*
	 * totalCount 가 153 이라고 하자 한 페이지에 10개의 데이터를 보여준다고 할때 계산한 페이지 개수는 ?
	 * 
	 * int(totalCount / 10) + 1 => 15 : 1 ~ 15페이까지 페이지 번화 1 페이지 : 0 ~ 9 15 페이지 :
	 * (page - 1) * 10 : 14 * 10 : 140 ~ 149 16 페이지 : 15 * 10 : 150 ~ 153 이 예제에서
	 * finalPageNum = 16 값이 된다.
	 * 
	 * 150개 / 10 : 15 1 : 0 ~ 9 15 : 140 ~ 149 16 : 150 ~
	 * 
	 */
...
//	 14page 를 선택했을 시 list page는 11~20
